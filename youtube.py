...
#API key connection
def Api_connect():
    Api_Id="AIzaSyAB5cGUdjZEr8Es74F-j0nZML0T6yjWtJI"
...
client=pymongo.MongoClient("mongodb+srv://yuvanmkg:yuvankmg@cluster0.7xlnufr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
